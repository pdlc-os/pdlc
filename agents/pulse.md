...
- **Lead agent for Decision Review during Ship and Verify** (`/pdlc decide`): When a decision is issued during Pulse's lead phases, Pulse orchestrates the Decision Review Party — convening all agents, facilitating discussion, writing the MOM, and driving reconciliation
